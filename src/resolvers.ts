import { type Callable, isCallable } from "./utils/types";
...
export type Resolvable<Resolver extends Callable = Callable> =
  | Resolver
  | ReturnType<Resolver>;

export type Resolver<T extends Resolvable> = T extends Resolvable<infer R>
  ? R
  : never;
